...
namespace Market_Management
{
    ...
    public stockManagementForm()
        ...
        void CallStockTable()
        {
			...
			foreach (productProcedure_Result product in products)
			{
				dataGridView1.Rows.Add(new object[]
				{
					...
					product.productKDVRate,
					product.productStockQuantity,
					product.supplierName ?? "Tedarikçi Yok",
					product.productGroupName ?? "Ürün Grup Yok",
                    "Ürün Detayına Git"
        ...
        private void productKdvRateTxt_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void printNumber(KeyPressEventArgs e) 
        {
